...
class FieldTypesTest extends TestCase
{
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'bigIncrements_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'bigInteger_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'binary_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'boolean_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'char_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'date_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'dateTime_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'dateTimeTz_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'decimal_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'double_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'email_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'enum_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'float_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'geometry_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'geometryCollection_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'increments_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'integer_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'ipAddress_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'json_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'jsonb_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'lineString_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'longText_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'macAddress_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'mediumIncrements_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'mediumInteger_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'mediumText_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'multiLineString_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'multiPoint_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'multiPolygon_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'nullable_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'point_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'polygon_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'smallIncrements_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'smallInteger_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'softDeletes_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'softDeletesTz_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'string_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'text_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'time_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'timeTz_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'timestamp_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'timestampTz_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'tinyIncrements_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'tinyInteger_field');
    ...
    public function setup_unique()
    {
        $model = new BigBang();
        $model->id = 1;
        $field = $model->getSmartFields()->firstWhere('name', 'unique_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'unsignedBigInteger_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'unsignedDecimal_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'unsignedInteger_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'unsignedMediumInteger_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'unsignedSmallInteger_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'unsignedTinyInteger_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'slug_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'url_field');
    ...
    {
        $model = new BigBang();
        $field = $model->getSmartFields()->firstWhere('name', 'uuid_field');
